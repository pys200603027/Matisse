...
public class MediaSelectionLazyFragment extends Fragment implements
    ...
    public static MediaSelectionLazyFragment newInstance(Album album) {
    ...
    public void setmSelectionProvider(SelectionProvider mSelectionProvider) {
    ...
    public void attach(Object object) {
        if (object instanceof SelectionProvider) {
            mSelectionProvider = (SelectionProvider) object;
        } else {
            throw new IllegalStateException("Context must implement SelectionProvider.");
        }
        if (object instanceof AlbumMediaAdapter.CheckStateListener) {
            mCheckStateListener = (AlbumMediaAdapter.CheckStateListener) object;
        }
        if (object instanceof AlbumMediaAdapter.OnMediaClickListener) {
            mOnMediaClickListener = (AlbumMediaAdapter.OnMediaClickListener) object;
        }
    }
